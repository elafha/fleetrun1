...
TWILIO_PHONE_NUMBER = '905355561712'  # This is your Twilio phone number
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": "super-unsecure-secret-key",
    "VERIFYING_KEY": "",
    "AUDIENCE": None,
    "ISSUER": None,
    "JSON_ENCODER": None,
...
SECRET_KEY = 'django-insecure-ch(0zh6c5*=fi-68&_))#yrf3!*hn_jcch^^bxv1#_f6nbib^-'
...
#     'SLIDING_TOKEN_REFRESH_LIFETIME': timedelta(days=1),  # Set refresh token lifetime
